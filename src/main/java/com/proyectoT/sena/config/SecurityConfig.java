...
import com.proyectoT.sena.service.CustomUserDetailsService; // <--- CORREGIDO (Antes decía UserDetailsServiceImpl)
...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // <--- ¡ESTO ACTIVA LA PROTECCIÓN DE RUTAS!
@RequiredArgsConstructor
public class SecurityConfig {

    private final CustomUserDetailsService userDetailsService; // <--- Usamos tu clase real
    ...
    // ... (El resto de tus beans CORS y AuthManager déjalos igual, están bien)
    @Bean
